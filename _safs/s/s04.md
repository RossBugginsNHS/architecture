...
assessment_examples:
  '0': |
    - Objectives vague / absent; user needs undocumented.
      - Some needs listed; not validated; objectives lack metrics.
  '2': |
    - Metrics defined for a few objectives; weak trace to architecture.
      - Systematic need → objective mapping; partial metric baselines.
  '4': |
    - Complete trace matrix; measurable objectives driving design decisions.
      - Automated trace validation; objective progress influences architectural prioritisation dynamically.
