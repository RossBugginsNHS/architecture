...
assessment_examples:
  '0': |
    - No capability mapping; ad-hoc feature list only.
      - Partial mapping; inconsistent capability granularity; duplicates unidentified.
  '2': |
    - Mapping table for key areas; duplication noted informally; no actions.
      - Broad coverage; overlaps flagged; consolidation backlog forming.
  '4': |
    - Full mapping with ownership & metrics; consolidation actions progressing.
      - Automated model sync; duplication KPI trending down; capability changes propagate to roadmap & architecture views.
