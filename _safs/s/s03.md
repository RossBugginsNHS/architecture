...
assessment_examples:
  '0': |
    - No documented vision or roadmap; only backlog tickets.
      - Vision slide exists; roadmap is feature date list; no metrics.
  '2': |
    - Outcome phrasing emerging; some epics mapped; metrics baseline missing.
      - Roadmap outcome-based for near-term; longer horizon reverts to features.
  '4': |
    - Vision & roadmap fully outcome-oriented with metrics & runway alignment.
      - Data-driven adjustments each cycle; outcome metrics dashboard integrated; scenario variants evaluated.
