...
assessment_examples:
  '0': |
    - No stakeholder list; decisions made in isolation.
      - Stakeholders invited late; feedback verbal only.
  '2': |
    - RACI drafted but outdated; key roles missing (security/data).
      - Stakeholder map current; majority of key decisions show review evidence.
  '4': |
    - Timely involvement; feedback log with dispositions; escalation path used.
      - Metrics on turnaround & satisfaction; continuous optimisation of participation.
