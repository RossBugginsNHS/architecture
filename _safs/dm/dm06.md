...
assessment_examples:
  '0': |
    - No governance model; ad-hoc reviews.
      - Heavyweight gate borrowed from another programme; low adherence.
  '2': |
    - Defined roles & forums; decisions inconsistently logged.
      - Tailoring matrix applied; exceptions tracked manually.
  '4': |
    - Automated policy checks; exception review cadence; metrics reported.
      - Governance-as-code pervasive; continuous feedback loops refine controls.
