...
assessment_examples:
  '0': |
    - No ADRs; rationale tribal knowledge.
      - ADRs created retroactively; missing alternatives.
  '2': |
    - Some timely ADRs; status management inconsistent; superseded deleted.
      - Majority decisions recorded; alternatives & consequences mostly present.
  '4': |
    - Complete ADR lifecycle; supersession chains; lint checks enforced.
      - Decision knowledge base queryable; metrics on coverage & revisit triggers.
