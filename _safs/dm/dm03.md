...
assessment_examples:
  '0': |
    - No risk register; risks only discussed verbally.
    - Issues and risks conflated.
      - List of risks with vague statements (no cause/event/effect).
      - No scoring or owners.
  '2': |
    - Basic scoring (H/M/L); sporadic owners.
    - Mitigations are generic (“improve performance”).
      - Structured register; inherent vs residual partly captured.
      - Review cadence irregular; some overdue.
  '4': |
    - Consistent pattern statements; mitigations tracked to delivery tasks.
    - Residual trend improving; high risks have exec visibility.
      - Dynamic dashboard; automated alerts for overdue / severity change.
      - Risks linked to decisions, debt & incidents; continuous reassessment.
