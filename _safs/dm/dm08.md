...
assessment_examples:
  '0': |
    - Decisions made informally; no documented options.
      - Single-option “evaluation” documents; criteria absent.
  '2': |
    - Criteria listed post-hoc; limited scoring explanation.
      - Structured tables with options & scores; some rationale thin.
  '4': |
    - Weighted criteria, sensitivity analysis; revisit triggers defined.
      - Historical decisions re-evaluated; outcome vs predicted tracked.
