...
assessment_examples:
  '0': |
    - No regular forum; ad-hoc chats substitute.
      - Forum exists but agenda is status updates; outcomes unrecorded.
  '2': |
    - Decision backlog board started; cycle time not measured.
      - Consistent cadence; backlog flow visible; some latency outliers.
  '4': |
    - Cycle time metrics & rework rate tracked; escalations defined.
      - Continuous improvement: throughput, quality & latency KPIs optimised; automation creates ADR drafts.
