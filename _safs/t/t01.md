...
assessment_examples:
  '0': |
    - Technology adopted without radar entry or evaluation.
      - Radar entry exists; rationale thin; success criteria undefined.
  '2': |
    - Evaluation template populated; trial outcomes partially measured.
      - Ring movements justified with metrics; exception list maintained.
  '4': |
    - Skill readiness & upgrade cadence tracked; automated drift alerts.
      - Data-driven adoption lifecycle: post-adoption KPIs drive promotion / retirement proactively.
