...
assessment_examples:
  '0': |
    - No vendor lock analysis; risks unknown.
      - Basic qualitative risk notes; mitigation absent.
  '2': |
    - Scored matrix with some mitigations; exit untested.
      - Abstraction / export paths implemented; annual exit simulation planned.
  '4': |
    - Regular exit drills executed; contract triggers monitored automatically.
      - Predictive lock-in risk dashboard; mitigation cost-benefit optimised continuously.
