...
assessment_examples:
  '0': |
    - Self-managed choices by default; SaaS not considered.
      - SaaS considered superficially; fit-gap undocumented.
  '2': |
    - Fit-gap analysis drafted; cost model incomplete; exit plan missing.
      - Evidence-based adoption with cost & responsibility matrix; exceptions tracked.
  '4': |
    - SLA monitoring & value realisation reviews; exit preparedness improving.
      - Proactive optimisation: automated SLA breach alerts & periodic exit simulations for critical SaaS.
