...
assessment_examples:
  '0': |
    - No principle/policy mapping; implicit compliance assumptions.
      - Incomplete matrix; several principles unassessed; outdated catalogue.
  '2': |
    - Basic mapping with Applicability & generic evidence references; exceptions informal.
      - Full matrix with Partial & Exception clearly separated; review cadence emerging.
  '4': |
    - Automated policy checks supplement matrix; aging exceptions reduced with action tracking.
      - Continuous sync with authoritative catalogue; metrics on closure rates & exception half-life reported.
