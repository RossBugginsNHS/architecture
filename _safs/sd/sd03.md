...
assessment_examples:
  '0': |
    - No documented standards; implicit assumptions only.
      - List exists but lacks applicability or version fields.
  '2': |
    - Applicability & versions recorded; evidence/gap fields incomplete.
      - Majority of mandatory standards have evidence; remediation actions tracked.
  '4': |
    - Version drift monitored; automated lint for key standards (API, accessibility).
      - Continuous verification & dashboard; proactive alerting on upstream standard changes.
