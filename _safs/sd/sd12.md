...
assessment_examples:
  '0': |
    - No Well-Architected assessment performed.
      - Single baseline assessment; actions vague or untracked.
  '2': |
    - Initial backlog of remediation items; inconsistent follow-up.
      - Regular assessments; pillar score trends visible; action closure improving.
  '4': |
    - Automation & metrics integrated; high-risk findings addressed within SLA.
      - Continuous improvement loop with automated evidence ingestion & predictive prioritisation.
