...
assessment_examples:
  '0': |
    - Versions retire ad-hoc; no documented policy.
      - Support matrix exists; deprecation notices inconsistent.
  '2': |
    - Standard notice template adopted; tracking deprecated usage manually.
      - Automated analytics on deprecated traffic; planned retirement timelines.
  '4': |
    - Breaking change detection gating merges; consumers migrated proactively with progress dashboard.
      - Predictive churn modelling & automated phased retirement enforcement with minimal disruption.
