...
assessment_examples:
  '0': |
    - Accessibility ignored; no tests or audits.
      - One-off automated scan; many issues unresolved.
  '2': |
    - Component library partially accessible; manual audits occasional.
      - Regular automated + manual audits; defect trend improving.
  '4': |
    - Accessibility gating in CI; performance budgets supporting UX.
      - Inclusive design embedded; proactive regression prevention & public reporting.
