...
assessment_examples:
  '0': |
    - No DR plan; backups ad-hoc or absent.
      - Documented plan; tests not executed.
  '2': |
    - Periodic manual test; recovery metrics untracked vs objectives.
      - Regular drills & restore tests; metrics vs RTO/RPO captured.
  '4': |
    - Automated scheduling & dependency risk integration; improvement trend.
      - Continuous readiness validation & scenario simulation coverage.
