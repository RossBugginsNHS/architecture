...
assessment_examples:
  '0': |
    - No performance model; ad-hoc load testing.
      - Single pre-go-live test; limited scenario coverage.
  '2': |
    - Workload taxonomy drafted; recurring tests partial.
      - Comprehensive benchmark suite; regression tracking active.
  '4': |
    - Performance budgets enforced pre-merge; exceptional scenarios validated.
      - Predictive capacity modelling integrated into planning & autoscaling.
